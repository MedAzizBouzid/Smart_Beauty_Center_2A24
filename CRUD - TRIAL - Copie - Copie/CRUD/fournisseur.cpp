...
QSqlQueryModel* fournisseur::cherhcer(QString code){
        ...
        QSqlQuery qry;
         ...
         qry.prepare("SELECT* FROM fournisseurs where Code_F like '%"+code+"%'");
...
QSqlQueryModel* fournisseur::cherhcer_local(QString local){
        ...
        QSqlQuery qry;
         ...
         qry.prepare("SELECT * FROM fournisseurs where Localisation like '%"+local+"%'");
...
QSqlQueryModel* fournisseur::cherhcer_type(QString type){
        ...
        QSqlQuery qry;
         ...
         qry.prepare("SELECT * FROM fournisseurs where Type_P like '%"+type+"%'");
...
QSqlQueryModel* fournisseur::tri(QString code){
            QSqlQuery qry;
             qry.prepare("select * from fournisseurs where Type_P like '%"+code+"%' order by Prix");
             qry.bindValue(":code",code);
             qry.exec();
             QSqlQueryModel *model= new QSqlQueryModel;
             model->setQuery(qry);
