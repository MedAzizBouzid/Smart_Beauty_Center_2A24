...
//Controle de saisie
            ...
            ui->comboBox_5->setModel(Etmp.wombo_combo2());
            ...
            ui->Mod_Nom_2->setValidator(valiNom);
            ui->Mod_Role_2->setValidator(valiNom);
            ui->Mod_Prenom_2->setValidator(valiNom);

            QPixmap pixS("C:/Users/LENOVO/Desktop/Gestion Employee/background.png");
                ui->background_6->setPixmap(pixS);
                ui->background_7->setPixmap(pixS);
                ui->background_8->setPixmap(pixS);
                ui->background_9->setPixmap(pixS);

                //**********************************AZIZ chehata***************************************
                ui->Acode_s_3->setValidator(new QIntValidator(100, 99999, this));
                 ui->Aprix_3->setValidator(new QIntValidator(0, 99999, this));

                 ui->lineEdit_nv_prix_3->setValidator(new QIntValidator(0,99999,this));
              ui->Scode_s_3->setValidator(new QIntValidator(0,99999,this));
...
void MainWindow::on_B_ModifierEmploye_2_clicked()
{
    int id = ui->comboBox->currentText().toInt();
        QString nom= ui->Mod_Nom_2->text();
        QString prenom= ui->Mod_Prenom_2->text();
        QString role= ui->Mod_Role_2->text();
        QString adresse= ui->Mod_Adresse_2->text();
        int telephone= ui->Mod_Telephone_2->text().toInt();
...
void MainWindow::on_Valide_Modif_3_clicked()
{
