...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QIcon icon;
        icon.addFile(QStringLiteral("../Images/livraison-fournisseurs-achats-gestion-commerciale.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        label->setGeometry(QRect(380, 0, 381, 381));
        label->setPixmap(QPixmap(QString::fromUtf8("../Images/livraison-fournisseurs-achats-gestion-commerciale.png")));
        ...
        label_9->setGeometry(QRect(0, 80, 71, 31));
        label_9->setFont(font);
        lineEdit_5 = new QLineEdit(groupBox_2);
        lineEdit_5->setObjectName(QStringLiteral("lineEdit_5"));
        lineEdit_5->setGeometry(QRect(80, 80, 113, 22));
        label_10 = new QLabel(groupBox_2);
        label_10->setObjectName(QStringLiteral("label_10"));
        label_10->setGeometry(QRect(0, 180, 51, 31));
        QFont font1;
        ...
        lineEdit_6->setGeometry(QRect(60, 180, 113, 22));
        ...
        lineEdit_7->setGeometry(QRect(190, 280, 113, 22));
        ...
        lineEdit_8->setGeometry(QRect(110, 350, 113, 22));
        QIcon icon1;
        ...
        label_2->setPixmap(QPixmap(QString::fromUtf8("../Images/livraison-fournisseurs-achats-gestion-commerciale.png")));
        ...
        label_7->setGeometry(QRect(0, 270, 201, 21));
        label_7->setFont(font);
        lineEdit_3 = new QLineEdit(groupBox);
        lineEdit_3->setObjectName(QStringLiteral("lineEdit_3"));
        lineEdit_3->setGeometry(QRect(220, 270, 111, 22));
        QIcon icon2;
        icon2.addFile(QStringLiteral("../Images/modiif.jpg"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        label_3->setPixmap(QPixmap(QString::fromUtf8("../Images/livraison-fournisseurs-achats-gestion-commerciale.png")));
        ...
        label_8->setGeometry(QRect(0, 80, 131, 31));
        label_8->setFont(font);
        lineEdit_4 = new QLineEdit(groupBox_3);
        lineEdit_4->setObjectName(QStringLiteral("lineEdit_4"));
        lineEdit_4->setGeometry(QRect(150, 80, 113, 22));
        QIcon icon3;
        icon3.addFile(QStringLiteral("../Images/miinus.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        label_4->setPixmap(QPixmap(QString::fromUtf8("../Images/livraison-fournisseurs-achats-gestion-commerciale.png")));
        ...
        label_13->setGeometry(QRect(0, 80, 131, 31));
        label_13->setFont(font);
        lineEdit_9 = new QLineEdit(groupBox_4);
        lineEdit_9->setObjectName(QStringLiteral("lineEdit_9"));
        lineEdit_9->setGeometry(QRect(150, 80, 113, 22));
        QIcon icon4;
        icon4.addFile(QStringLiteral("../Images/afficher.png"), QSize(), QIcon::Normal, QIcon::Off);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        label_9->setText(QApplication::translate("MainWindow", "<html><head/><body><p><span style=\" font-size:10pt;\">Code_F :</span></p></body></html>", Q_NULLPTR));
        label_10->setText(QApplication::translate("MainWindow", "<html><head/><body><p><span style=\" font-size:10pt;\">Type: </span></p></body></html>", Q_NULLPTR));
        label_11->setText(QApplication::translate("MainWindow", "<html><head/><body><p><span style=\" font-size:10pt;\">Numero de telephone: </span></p></body></html>", Q_NULLPTR));
        label_12->setText(QApplication::translate("MainWindow", "<html><head/><body><p><span style=\" font-size:10pt;\">Localisation: </span></p></body></html>", Q_NULLPTR));
        ...
        label_5->setText(QApplication::translate("MainWindow", "<html><head/><body><p><span style=\" font-size:10pt;\">Donner Code_F :</span></p></body></html>", Q_NULLPTR));
        label_6->setText(QApplication::translate("MainWindow", "<html><head/><body><p><span style=\" font-size:10pt;\">Donner l'atribut a modifier :</span></p><p><br/></p></body></html>", Q_NULLPTR));
        label_7->setText(QApplication::translate("MainWindow", "<html><head/><body><p><span style=\" font-size:10pt;\">Donner nouvelle valeur :</span></p><p><br/></p></body></html>", Q_NULLPTR));
        ...
        label_8->setText(QApplication::translate("MainWindow", "<html><head/><body><p><span style=\" font-size:10pt;\">Donner Code_F :</span></p></body></html>", Q_NULLPTR));
        ...
        label_13->setText(QApplication::translate("MainWindow", "<html><head/><body><p><span style=\" font-size:10pt;\">Donner Code_F :</span></p></body></html>", Q_NULLPTR));
