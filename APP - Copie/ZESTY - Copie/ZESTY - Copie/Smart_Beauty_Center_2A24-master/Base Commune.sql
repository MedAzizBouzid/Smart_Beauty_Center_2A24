...
Code_F VARCHAR2(8 char) ,
Localisation VARCHAR2(50 char) ,
Num_tel VARCHAR2(8 char) UNIQUE,
...
Produit VARCHAR2(13 byte),
Fournisseur VARCHAR2(8 char),
...
--CONSTRAINT Fournir_Produit_Fournisseur_pk Primary key (Produit,Fournisseur)
);
...
--CONSTRAINT Manipuler_Prod_Emp_pk PRIMARY KEY (Prod,Emp)
);
CREATE TABLE Client(
Code_C NUMBER,
Num_tel VARCHAR2 (20 char) UNIQUE,
Nom VARCHAR2 (50 char),
Prenom VARCHAR2 (50 char),
Adresse_Mail VARCHAR2(50 char),
Date_RDV VARCHAR2 (20 byte),
S_Attribue VARCHAR2 (20 byte),
...
--CONSTRAINT Servir_Client_Employe_pk PRIMARY KEY(Cli,Emp)
);
